...
final class ITermTerminalDriverTests: XCTestCase {
    ...
    func testFocusReturnsFocusedWhenTTYMatches() async {
        ...
        let driver = ITermTerminalDriver(
    ...
    func testLaunchReturnsFalseWhenOpenFails() async {
        ...
        XCTAssertTrue(commands[0].contains("open -b com.googlecode.iterm2"))
        XCTAssertEqual(
            driver.lastFailureReason,
            .hostOperationFailed(
                app: .iTerm,
    ...
    func testLaunchReturnsFalseWhenSendCommandFails() async {
        ...
        XCTAssertTrue(commands[1].contains("tell application \"iTerm\""))
        XCTAssertTrue(commands[1].contains("write text"))
        XCTAssertFalse(commands[1].contains("tell process \"iTerm2\""))
        XCTAssertEqual(
            driver.lastFailureReason,
            .hostOperationFailed(
                app: .iTerm,
