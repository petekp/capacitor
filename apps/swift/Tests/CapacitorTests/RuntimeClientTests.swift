...
final class RuntimeClientTests: XCTestCase {
    ...
    private static func makeCoreSnapshotResponse(
        ...
        let sessionGcReasonField = if let sessionGcReasonJSON {
            ",\"gc_reason\":\(sessionGcReasonJSON)"
        } else {
            ""
        }
